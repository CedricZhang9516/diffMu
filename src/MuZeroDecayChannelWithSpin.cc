...
MuZeroDecayChannelWithSpin::MuZeroDecayChannelWithSpin()
  : MuZeroDecayChannel()
{
}

MuZeroDecayChannelWithSpin::MuZeroDecayChannelWithSpin(const G4String& theParentName, 
						       G4double        theBR)
  : MuZeroDecayChannel(theParentName,theBR)
{
}
...
MuZeroDecayChannelWithSpin::MuZeroDecayChannelWithSpin(const MuZeroDecayChannelWithSpin &right):
  MuZeroDecayChannel(right)
{
}

MuZeroDecayChannelWithSpin & MuZeroDecayChannelWithSpin::operator=(const MuZeroDecayChannelWithSpin & right)
{
  if (this != &right) { 
...
G4DecayProducts *MuZeroDecayChannelWithSpin::DecayIt(G4double) 
{
...
#ifdef G4VERBOSE
  if (GetVerboseLevel()>1) G4cout << "MuZeroDecayChannelWithSpin::DecayIt ";
#endif
  ...
  if (GetVerboseLevel()>1) {
    G4cout << "MuZeroDecayChannelWithSpin::DecayIt ";
...
G4double MuZeroDecayChannelWithSpin::R_c(G4double x,G4double omega){
